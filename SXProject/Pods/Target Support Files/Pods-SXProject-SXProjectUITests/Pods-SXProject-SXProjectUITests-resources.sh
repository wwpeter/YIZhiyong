...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/../Depend/GuidePageView/GuidePageView/GuideImage.bundle"
  ...
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/ZLPhotoBrowser/ZLPhotoBrowser_Privacy.bundle"
fi
