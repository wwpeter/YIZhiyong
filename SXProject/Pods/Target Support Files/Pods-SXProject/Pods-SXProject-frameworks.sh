...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/BGCocoaLumberjack/BGCocoaLumberjack.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/BGURLRouter/BGURLRouter.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/BITBaseTabBarController/BITBaseTabBarController.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/BITCategories/BITCategories.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/DHModule/DHModule.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/HZNavigationBar/HZNavigationBar.framework"
