...
- (NSString *)lc_EncryptToServerWithPwd:(NSString *)password
{
    ...
    NSData *decData = [srcData lc_AES256CBCEncryptWithKey:realPwd iv:@"boolean1290dk2.*"];
    return [decData base64String];
}
/*
 密钥：booleancloud_a2320sdj11_.%232sdh
 偏移量：boolean1290dk2.*
 */
- (NSString *)lc_DecryptToServerWithPwd:(NSString *)password
{
   ...
   // NSString *realPwd = [[[password uppercaseString] stringByAppendingString:@"DAHUAKEY"] lc_MD5Digest];
    NSString *realPwd = [self decodeBase64String:password];
    NSData *decData = [srcData lc_AES256CBCDecryptWithKey:realPwd iv:@"boolean1290dk2.*"];
