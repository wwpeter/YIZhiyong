...
@interface AESUtilNew()
 
@end
 
// 秘钥key
const NSString *AESKeyNew = @"97uoohEb3LtlRQqS";//0QZ1jSsInNhiQtIt3aESNg==

@implementation AESUtilNew

+ (NSString *)aesEncrypt:(NSString *)sourceStr{ // AES加密
   if (!sourceStr) {
       return nil;
   }
   char keyPtr[kCCKeySizeAES256 + 1];
   bzero(keyPtr, sizeof(keyPtr));
   [AESKeyNew getCString:keyPtr maxLength:sizeof(keyPtr) encoding:NSUTF8StringEncoding];
