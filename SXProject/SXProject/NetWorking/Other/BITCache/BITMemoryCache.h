/**
 `BITMemoryCache` is a fast, thread safe key/value store similar to `NSCache`. On iOS it will clear itself
 ...
 Values will not persist after application relaunch or returning from the background. See <BITCache> for
 a memory cache backed by a disk cache.
 */

#import <Foundation/Foundation.h>

@class BITMemoryCache;

typedef void (^BITMemoryCacheBlock)(BITMemoryCache *cache);
typedef void (^BITMemoryCacheObjectBlock)(BITMemoryCache *cache, NSString *key, id object);

@interface BITMemoryCache : NSObject
 ...
 */
@property (copy) BITMemoryCacheObjectBlock willAddObjectBlock;
 ...
 */
@property (copy) BITMemoryCacheObjectBlock willRemoveObjectBlock;
 ...
 */
@property (copy) BITMemoryCacheBlock didReceiveMemoryWarningBlock;
 ...
 */
@property (copy) BITMemoryCacheBlock didEnterBackgroundBlock;
 ...
 */
- (void)trimToDate:(NSDate *)date block:(BITMemoryCacheBlock)block;
 ...
 */
- (void)handleMemoryWarning __deprecated_msg("This happens automatically in BITCache 2.1. There’s no longer a need to call it directly.");

/**
 Handle the application having been backgrounded.
 */
- (void)handleApplicationBackgrounding __deprecated_msg("This happens automatically in BITCache 2.1. There’s no longer a need to call it directly.");
