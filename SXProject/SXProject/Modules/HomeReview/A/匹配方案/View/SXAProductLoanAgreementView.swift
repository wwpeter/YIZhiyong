//
//  SXAProductLoanAgreementView.swift
//  SXProject
//
...
///协议
class SXAProductLoanAgreementView: UIView, WKNavigationDelegate {
    ...
    func loadWebView(privacy: Bool) {
        if privacy ==  true {
            if let url = URL(string: String.init(format: "%@%@", kWebUrlBase, kLoanWarningNotice)) {
