...
import UIKit
/// 1 关闭 2 继续
typealias AlertViewFillFirstBlock = (_ type: String) -> Void
class AlertViewFillFirst: UIView {

    var typeBlock: AlertViewFillFirstBlock?
...
//            self.contentView.transform = CGAffineTransformMakeScale
    ...
    private lazy var submitBut: UIButton = {
        let but = CreateBaseView.makeBut("继续填写", kTBlue, kWhite,  UIFont.sx.font_t16Blod)
