...
internal enum Asset {
  ...
  internal enum Images {
    ...
    internal static let aLoadStauat1 = ImageAsset(name: "a_load_stauat_1")
    internal static let aLoanIcon1 = ImageAsset(name: "a_loan_icon_1")
    internal static let aRedDout = ImageAsset(name: "a_red_dout")
    internal static let disabuseQuestion1 = ImageAsset(name: "disabuse_question_1")
    internal static let disabuseQuestion2 = ImageAsset(name: "disabuse_question_2")
    internal static let disabuseQuestion3 = ImageAsset(name: "disabuse_question_3")
    internal static let disabuseQuestion4 = ImageAsset(name: "disabuse_question_4")
    internal static let disabuseQuestion5 = ImageAsset(name: "disabuse_question_5")
    internal static let disabuseQuestion6 = ImageAsset(name: "disabuse_question_6")
    internal static let disabuseQuestionBook = ImageAsset(name: "disabuse_question_book")
    internal static let disabuseQuestionTitle = ImageAsset(name: "disabuse_question_title")
